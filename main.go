...
func main() {
	...
	flag.StringVar(&binaryVersion, "binary-version", "0.3.10", "Version of own runner binary")
	flag.StringVar(&runnerVersion, "runner-version", "2.283.1", "Version of GitHub Actions runner")
	flag.Parse()
