...
type RunnerSpec struct {
	...
	// Compute Resources required by the container image builder.
	// More info: https://kubernetes.io/docs/concepts/configuration/manage-compute-resources-container/
	BuilderResources v1.ResourceRequirements `json:"builderResources,omitempty" protobuf:"bytes,8,opt,name=builderResources"`
}
